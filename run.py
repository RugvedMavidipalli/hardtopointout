...
def parse_args():
	...
	parser.add_argument("--scene", "--training_data", default="./transforms.json", help="The scene to load. Can be the scene's name or a full path to the training data.")
